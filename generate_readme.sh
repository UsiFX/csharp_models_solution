...
ARRAYS_1D_MODELS=(
    ...
    ["B4"]="Increase elements at even indices by 3 and at odd indices by 4 in a 10-element user-provided array, then print the modified array."
...
echo "- \`--\` separates dotnet CLI options from application arguments. All tokens after \`--\` are forwarded to \`Main(string[] args)\`." >> "$README_FILE"
echo "" >> "$README_FILE"
echo "---" >> "$README_FILE"
echo "" >> "$README_FILE"
